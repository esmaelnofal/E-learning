  ...
  return (
    <div className='MainContent'>
      <div className='leftMainContent'>
        ...
        <img src={client2} alt='client2' className='clientImage' style={{marginLeft:"-10px"}}/>
        <img src={client3} alt='client3' className='clientImage' style={{marginLeft:"-10px"}}/>
      <img src={image4} alt='image4' className='clientImage' style={{marginLeft:"-15px", height: "50px", width: "50px"  }}/>
      </div>
